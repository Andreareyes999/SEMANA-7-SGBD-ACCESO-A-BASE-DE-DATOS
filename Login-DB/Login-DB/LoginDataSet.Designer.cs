...
namespace Login_DB.LoginDataSetTableAdapters {
    ...
    public partial class usuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `usuarios` (`usuario`, `clave`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `usuarios` SET `usuario` = ?, `clave` = ? WHERE ((`Id` = ?) AND ((? = 1 AN" +
                "D `usuario` IS NULL) OR (`usuario` = ?)) AND ((? = 1 AND `clave` IS NULL) OR (`c" +
                "lave` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Login_DB.Properties.Settings.Default.LoginConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, usuario, clave FROM usuarios";
